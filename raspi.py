...
def readData():
    ...
    data = {
        "temp": round(compensate_T(temp_raw), 2),
        "hum": round(compensate_H(hum_raw), 2),
        "press": round(compensate_P(pres_raw), 2)
    }
...
while True:
    ...
    # print("Temperature:%6.2f" %(data["temp"]))
    # print("Humidity:%6.2f" %(data["hum"]))
    # print("Pressure:%6.2f" %(data["press"]))
